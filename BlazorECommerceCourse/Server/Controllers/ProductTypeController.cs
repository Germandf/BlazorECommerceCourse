...
public class ProductTypeController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<ServiceResponse<List<ProductType>>>> AddProductType([FromBody] ProductType productType)
    {
    ...
    [HttpPut]
    public async Task<ActionResult<ServiceResponse<List<ProductType>>>> UpdateProductType([FromBody] ProductType productType)
    {
